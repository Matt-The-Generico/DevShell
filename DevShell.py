...
def help():
    ...
    comandos = [
        (Fore.CYAN, "uuid: Gera um UUID"),
        (Fore.CYAN, "genpass: Gera uma senha forte aleatória"),
        (Fore.CYAN, "timestamp: Mostra o timestamp atual (epoch e formato legível)"),
        (Fore.CYAN, "dateconv <ts>: Converte timestamp para data legível"),
        (Fore.CYAN, "base64enc <txt>: Codifica texto em Base64"),
        (Fore.CYAN, "base64dec <txt>: Decodifica texto em Base64"),
        (Fore.CYAN, "calc: Calculadora de terminal (suporta expressões)"),
        (Fore.CYAN, "color <hex>: Mostra cor RGB a partir de hex e vice-versa"),
        (Fore.CYAN, "qrgen <txt>: Gera um QR code a partir de texto/url"),
        (Fore.GREEN, "ls: Lista arquivos da pasta atual"),
        (Fore.GREEN, "cd <dir>: Muda de diretório"),
        (Fore.GREEN, "mkdir <nome>: Cria uma nova pasta"),
        (Fore.GREEN, "open <arquivo>: Abre arquivo no editor padrão"),
        (Fore.GREEN, "search <termo>: Busca por arquivos com o nome que contenha <termo>"),
        (Fore.GREEN, "read <arquivo>: Lê o conteúdo de um arquivo no terminal"),
        (Fore.GREEN, "touch <nome>: Cria um novo arquivo vazio"),
        (Fore.RED, "gitstatus: Mostra status atual do repositório Git"),
        (Fore.RED, "gitbranch: Lista branches"),
        (Fore.RED, "gitlog: Mostra últimos 5 commits"),
        (Fore.RED, "gitreset: Reset hard para o último commit (requer confirmação)"),
        (Fore.RED, 'gpush: Atalho para git add . && git commit -m "" && git push'),
        (Fore.YELLOW, "ip: Mostra IP local e público"),
        (Fore.YELLOW, "ping <site>: Faz ping e mede latência"),
        (Fore.YELLOW, "httpget <url>: Requisição GET e exibe JSON formatado"),
        (Fore.YELLOW, "headers <url>: Exibe cabeçalhos HTTP da URL"),
        (Fore.YELLOW, "speedtest: Testa velocidade de download e upload da sua rede Wi-Fi"),
        (Fore.YELLOW, "jsonfmt <arquivo>: Formata arquivo JSON"),
        (Fore.CYAN, "jsonval <arquivo>: Valida sintaxe JSON"),
        (Fore.CYAN, "regex <texto> <exp>: Testa expressão regular"),
        (Fore.CYAN, "minify <arquivo>: Minifica HTML, CSS ou JS"),
        (Fore.CYAN, "diff <arq1> <arq2>: Mostra diferenças entre dois arquivos"),
        (Fore.YELLOW, "hash <texto>: Gera hash SHA256"),
        (Fore.YELLOW, "comparehash <t1> <t2>: Compara dois hashes"),
        (Fore.YELLOW, "securedel <arq>: Deleta um arquivo com sobrescrita segura"),
        (Fore.GREEN, "serve: Sobe um servidor HTTP simples na pasta atual (requer confirmação)"),
        (Fore.GREEN, "portscan <ip>: Escaneia portas abertas em um IP"),
        (Fore.GREEN, "dockerps: Lista containers Docker em execução"),
        (Fore.GREEN, "dockerstart <id>: Inicia container Docker"),
        (Fore.GREEN, "ssh <host>: Acessa um servidor via SSH"),
        (Fore.RED, "todo: Lista tarefas do dev (em arquivo markdown)"),
        (Fore.RED, "addtodo '<tarefa>': Adiciona uma tarefa"),
        (Fore.RED, "deltodo <id>: Remove tarefa específica"),
        (Fore.RED, "exit: Fecha a janela do DevShell"),
        (Fore.RED, "help: imprime este output"),
    ]
