...
def help():
    ...
    comandos = [
        # Básicos (Verde)
        (Fore.GREEN, "uuid: Gera um UUID"),
        (Fore.GREEN, "genpass: Gera uma senha forte aleatória"),
        (Fore.GREEN, "timestamp: Mostra o timestamp atual (epoch e formato legível)"),
        (Fore.GREEN, "dateconv <ts>: Converte timestamp para data legível"),
        (Fore.GREEN, "calc: Calculadora de terminal (suporta expressões)"),
        (Fore.GREEN, "qrgen <txt>: Gera um QR code a partir de texto/url"),
        (Fore.GREEN, "color <hex>: Mostra cor RGB a partir de hex e vice-versa"),
        (Fore.YELLOW, "base64enc <txt>: Codifica texto em Base64"),
        (Fore.YELLOW, "base64dec <txt>: Decodifica texto em Base64"),
        ...
        (Fore.YELLOW, "jsonval <arquivo>: Valida sintaxe JSON"),
        (Fore.YELLOW, "regex <texto> <exp>: Testa expressão regular"),
        (Fore.YELLOW, "minify <arquivo>: Minifica HTML, CSS ou JS"),
        (Fore.BLUE, "ls: Lista arquivos da pasta atual"),
        (Fore.BLUE, "cd <dir>: Muda de diretório"),
        (Fore.BLUE, "mkdir <nome>: Cria uma nova pasta"),
        (Fore.BLUE, "open <arquivo>: Abre arquivo no editor padrão"),
        (Fore.BLUE, "search <termo>: Busca por arquivos com o nome que contenha <termo>"),
        (Fore.BLUE, "read <arquivo>: Lê o conteúdo de um arquivo no terminal"),
        ...
        (Fore.MAGENTA, "dockerstart <id>: Inicia container Docker"),
        (Fore.CYAN, "ip: Mostra IP local e público"),
        (Fore.CYAN, "ping <site>: Faz ping e mede latência"),
        (Fore.CYAN, "httpget <url>: Requisição GET e exibe JSON formatado"),
        (Fore.RED, "serve: Sobe um servidor HTTP simples na pasta atual (requer confirmação)"),
        (Fore.CYAN, "headers <url>: Exibe cabeçalhos HTTP da URL"),
        (Fore.CYAN, "speedtest: Testa velocidade de download e upload da sua rede Wi-Fi"),
        (Fore.CYAN, "portscan <ip>: Escaneia portas abertas em um IP"),
        (Fore.CYAN, "ssh <host>: Acessa um servidor via SSH"),
